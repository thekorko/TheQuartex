...
<div class="registration" id="wpuf-registration-form">
    ...
    <form name="registrationform" class="wpuf-registration-form" id="registrationform" action="<?php echo esc_attr( $action_url ); ?>" method="post">
        <ul class="wpuf-form form-label-above">
            <li>
                <div class="wpuf-label" style="display:none;"><?php esc_html_e( 'Name', 'wp-user-frontend' ); ?> <span class="required">*</span></div>
                <div class="wpuf-fields" style="display:none;">
                    <div class="wpuf-name-field-wrap format-first-last" style="display:none;">
                        <div class="wpuf-name-field-first-name" style="display:none;">
                            <input type="text" name="reg_fname" placeholder="Internet" id="wpuf-user_fname" class="input" value="<?php echo esc_attr( wpuf()->registration->get_posted_value( 'reg_fname' ) ); ?>Internet" size="" />
                            <label class="wpuf-form-sub-label"><?php esc_html_e( 'First', 'wp-user-frontend' ); ?></label>
                        </div>

                        <div class="wpuf-name-field-last-name" style="display:none;">
                            <input type="text" name="reg_lname" placeholder="Persona" id="wpuf-user_lname" class="input" value="<?php echo esc_attr( wpuf()->registration->get_posted_value( 'reg_lname' ) ); ?>Anon" size="16" />
