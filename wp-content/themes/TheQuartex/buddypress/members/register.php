...
?>
	...
	<div id="register-page"class="page register-page">
		...
		<?php bp_nouveau_template_notices(); ?>
			...
			<div class="layout-wrap g-recaptcha" data-sitekey="6LdXueQZAAAAAEG_Bz1du9tV2spc5gJTtlro2_td">
			...
			<?php if ( 'request-details' === bp_get_current_signup_step() ) : ?>
				...
				<?php /***** TODO hacer esto de una manera menos rancia Extra Profile Details ******/ ?>

				<?php if ( bp_is_active( 'xprofile' ) && bp_nouveau_base_account_has_xprofile() && 1==2) : ?>
